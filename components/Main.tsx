  ...
  return (
    <section className="text-black body-font lg:pt-20">
      ...
      <div className="container flex flex-col items-center justify-center py-8 mx-auto rounded-lg md:p-1 p-3">
        <Image
          className="object-cover object-center w-1/2 mb-10 border-gray-200 dark:border-gray-900 g327 border rounded-lg shadow-md"
          alt="hero"
          width={100}
          height={100}
          src={'/img.JPG'}
                ...
                <div className="p-4 lg:w-1/4 md:w-1/2">
                  <div className="h-full flex flex-col items-center text-center">
                    <Image
                      ...
                      src="/img.JPG"
                      className="flex-shrink-0 rounded-lg w-full h-56 object-cover object-center mb-4"
                      //   src="https://images.pexels.com/photos/18032307/pexels-photo-18032307/free-photo-of-clouds-over-green-hills.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                    ></Image>
                    <div className="w-full">
                      <h2 className="title-font font-medium text-lg text-white">
                        Chris
